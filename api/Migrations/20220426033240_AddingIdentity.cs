        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
          ...
          migrationBuilder.CreateTable(
              ...
              columns: table => new
              {
                ...
                LogContent = table.Column<string>(maxLength: 100, nullable: true),
                NoteContent = table.Column<string>(maxLength: 100, nullable: true)
              },
              constraints: table =>
              {
                table.PrimaryKey("PK_DatabaseLogs", x => x.LogID);
              });
